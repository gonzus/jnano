 ...
 *  
 */
JNIEXPORT jint JNICALL Java_org_nanomsg_NanoLibrary_nn_1sendbyt(JNIEnv* env,
                                                             jobject obj,
                                                             jint socket,
                                                             jbyteArray array,
                                                             jint flags)
...
/**
 * Send a string. Also sends the null terminating character at the end.
 */
...
/**
 * Receives the entire message as a string (presumes a null terminating character is sent).
 */
...
/**
 * Receives the entire message as a byte array
 */
JNIEXPORT jbyteArray JNICALL Java_org_nanomsg_NanoLibrary_nn_1recvbyt(JNIEnv* env,
                                                             jobject obj,
                                                             jint socket,
                                                             jint flags)
{
